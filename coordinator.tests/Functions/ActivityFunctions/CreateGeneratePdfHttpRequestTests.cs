...
namespace coordinator.tests.Functions.ActivityFunctions
{
    ...
    {
        private readonly CreateGeneratePdfHttpRequestActivityPayload _payload;
        ...
        public CreateGeneratePdfHttpRequestTests()
        {
            ...
            _payload = fixture.Create<CreateGeneratePdfHttpRequestActivityPayload>();
            ...
            mockGeneratePdfHttpFactory.Setup(client => client.Create(_payload.CaseUrn, _payload.CaseId, _payload.DocumentId, _payload.FileName, 
