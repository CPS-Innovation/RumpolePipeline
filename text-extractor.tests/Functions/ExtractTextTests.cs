...
namespace text_extractor.tests.Functions
{
	public class ExtractTextTests
	{
		...
		public async Task Run_StoresOcrResults()
		{
			...
			_mockSearchIndexService.Verify(service => service.StoreResultsAsync(_mockAnalyzeResults.Object, _extractTextRequest.CaseId, _extractTextRequest.DocumentId, _extractTextRequest.MaterialId, _extractTextRequest.LastUpdatedDate, _correlationId));
		}
