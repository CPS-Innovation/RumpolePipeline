    ...
    public class ExtractText
    {
        ...
        public async Task<HttpResponseMessage> Run([HttpTrigger(AuthorizationLevel.Function, "post", Route = "extract")] HttpRequestMessage request)
        {
            ...
            try
            {
                ...
                await _searchIndexService.StoreResultsAsync(ocrResults, extractTextRequest.CaseId, extractTextRequest.DocumentId, extractTextRequest.MaterialId, extractTextRequest.LastUpdatedDate, currentCorrelationId);
