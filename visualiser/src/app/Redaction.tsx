...
class Redaction extends Component<{ pdfUrl: string }, State> {
  state = {
    url: this.props.pdfUrl,
    highlights: testHighlights[this.props.pdfUrl]
      ? [...testHighlights[this.props.pdfUrl]]
      : [],
  };
    ...
    return (
      <div className="App" style={{ display: "flex", height: "100vh" }}>
        <Sidebar
          ...
          undoRedaction={this.removeHighlight}
        />
        <div
          style={{
            height: "100vh",
