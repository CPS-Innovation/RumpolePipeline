...
namespace rumpolepipeline.tests.coordinator.Functions
{
    public class CoordinatorOrchestratorTests
    {
        ...
        [Fact]
        public async Task Run_Tracker_InitializesWheTrackerIsAlreadyProcessedAndForceRefreshIsTrue()
        {
            _mockTracker.Setup(tracker => tracker.IsAlreadyProcessed()).ReturnsAsync(true);
        ...
        [Fact]
        public async Task Run_Tracker_Initializes()
        {
            await _coordinatorOrchestrator.Run(_mockDurableOrchestrationContext.Object);
