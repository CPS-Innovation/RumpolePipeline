...
namespace rumpolepipeline.tests.text_extractor.Services.SasGeneratorService
{
    public class SasGeneratorServiceTests
    {
        ...
        public SasGeneratorServiceTests()
        {
            ...
            _sasGeneratorService = new global::text_extractor.Services.SasGeneratorService.SasGeneratorService(mockBlobServiceClient.Object, mockBlobSasBuilderFactory.Object, mockBlobSasBuilderWrapperFactory.Object, mockBlobOptions.Object);
        }
